...
//   - api/inquire.js (included in this package)
...
export default function InquiryModal({ source = 'unknown', externalOpen = false, onExternalClose }) {
  const [open, setOpen] = useState(false);
  // Support external trigger (e.g. footer button)
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={submit} noValidate>
            ...
            <div style={{ marginBottom: '12px' }}>
              <label style={labelStyle}>What can I help with?</label>
              <select
                value={form.type}
